...
// Source: jackal/pkg/app (interfaces: IImageProcessingService)
...
func (m *MockIImageProcessingService) CropCentered(arg0 []byte, arg1, arg2 int, arg3 app.CropType) ([]byte, string, error) {
