...
// Source: jackal/pkg/app (interfaces: IDownloadAndCropImageUseCase)
...
func (m *MockIDownloadAndCropImageUseCase) Execute(arg0 string, arg1, arg2 int, arg3 app.CropType) ([]byte, string, error) {
